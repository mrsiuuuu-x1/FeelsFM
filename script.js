...
if (terminalContent) {
    const messages = [
        ">> CHECKING_SENSOR_STATUS...",
        ">> CONNECTION_STABLE (Ping: 14ms)",
        ">> AWAITING_INPUT...",
        ">> MEMORY_USAGE: 34MB",
        ">> CACHE_CLEARED",
        ">> ENCRYPTING_DATA_PACKETS...",
        ">> UPDATING_UI_ELEMENTS...",
        ">> SYSTEM_OPTIMAL"
    ];
    ...
    setInterval(() => {
        ...
        p.innerText = `[${time}] ${randomMsg}`;
        
        terminalContent.insertBefore(p, terminalContent.querySelector('.blinking-cursor'));
